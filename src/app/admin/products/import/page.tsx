        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              ...
              колона B — клиентска цена за литър/килограм <strong>с включен ДДС</strong>
              (цени в лева се конвертират автоматично в евро). Вискозитет и опаковка се
              извличат автоматично от името на всеки ред.
            </p>
          </div>
